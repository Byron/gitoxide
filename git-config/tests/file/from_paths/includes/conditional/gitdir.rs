...
fn temporary_dir_for_git(subdir_name: impl AsRef<Path>) -> (tempfile::TempDir, PathBuf) {
...
mod types {
    use crate::file::from_paths::includes::conditional::gitdir::home;
    use dirs::home_dir;
...
pub use types::{ConfigLocation, EnvOverwrite, Options, Value};

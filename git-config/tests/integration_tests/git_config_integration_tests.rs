...
mod from_env_tests {
    ...
    use git_config::file::{from_env, from_paths, GitConfig};
...
#[cfg(test)]
mod from_parser {
    use git_config::file::{GitConfig, LookupTreeNode, SectionBody, SectionId};
    use git_config::parser::{Event, SectionHeaderName};
    use git_config::test_util::{name_event, newline_event, section_header, value_event};
    use std::borrow::Cow;

...
impl Location {
    /// Compute a range suitable for lookup in pack data using the [`entry_slice()`][crate::pack::data::File::entry_slice()] method.
    pub fn entry_range(&self, pack_offset: u64) -> pack::data::EntryRange {

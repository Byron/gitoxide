mod walk {
    ...
    impl<'a> TraversalAssertion<'a> {
        fn new(init_script: &'a str, tips: &'a [&'a str], ends: &'a [&'a str], expected: &'a [&'a str]) -> Self {
            Self::new_at(init_script, "", tips, ends, expected)
        }
    ...
    impl TraversalAssertion<'_> {
        ...
        fn check_with_predicate(&mut self, predicate: impl FnMut(&oid) -> bool + Clone) -> crate::Result<()> {
            ...
            for use_commitgraph in [false, true] {
                let oids = topo::Builder::from_iters(&store, tips.iter().cloned(), Some(ends.iter().cloned()))
    ...
    mod basic {
        ...
        #[test]
        fn basic_with_dummy_predicate() -> crate::Result {
            TraversalAssertion::new(
                "make_repo_for_topo.sh",
                &["62ed296d9986f50477e9f7b7e81cd0258939a43d"],
                &[],
    ...
    mod first_parent {
        ...
        #[test]
        fn basic_first_parent() -> crate::Result {
            TraversalAssertion::new(
                "make_repo_for_topo.sh",
                &["62ed296d9986f50477e9f7b7e81cd0258939a43d"],
                &[],
        ...
        #[test]
        fn first_parent_with_end() -> crate::Result {
            TraversalAssertion::new(
                "make_repo_for_topo.sh",
                &["62ed296d9986f50477e9f7b7e81cd0258939a43d"],
                &["f1cce1b5c7efcdfa106e95caa6c45a2cae48a481"],
    ...
    mod date_order {
        ...
        #[test]
        fn basic_date_order() -> crate::Result {
            TraversalAssertion::new(
                "make_repo_for_topo.sh",

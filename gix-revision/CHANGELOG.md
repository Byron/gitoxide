...
* **Uncategorized**
    ...
    - Use `gix-object::Find` trait ([`36f70dc`](https://github.com/Byron/gitoxide/commit/36f70dcb378bff488dc65f0b354c74341b142e7e))
    ...
    - Merge branch 'fix-gix-rev' ([`d3fb537`](https://github.com/Byron/gitoxide/commit/d3fb5377bb3a90deae714e613d89a891fcf69d40))
    - Prevent underflows while trying to `abs()` very large numbers. ([`9b1a575`](https://github.com/Byron/gitoxide/commit/9b1a57574bab0639d3c38be2001f545a6c8e0333))

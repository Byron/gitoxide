...
mod in_parallel;
#[cfg(feature = "parallel")]
pub use in_parallel::{in_parallel, in_parallel_with_mut_slice_in_chunks, join, threads};

mod serial;
#[cfg(not(feature = "parallel"))]
pub use serial::{in_parallel, in_parallel_with_mut_slice_in_chunks, join, threads};

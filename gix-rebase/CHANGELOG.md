 ...
 * **Uncategorized**
    ...
    - Adjust to renaming of `git-rebase` to `gix-rebase` ([`f00e531`](https://github.com/Byron/gitoxide/commit/f00e53108f8a2de01f84fef35f9278b9114cf9dc))
    - Rename `git-rebase` to `gix-rebase` ([`0842cfd`](https://github.com/Byron/gitoxide/commit/0842cfdebac16b244053dc44f66f38c5b729676a))

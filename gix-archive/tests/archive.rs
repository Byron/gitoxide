...
mod write_to {
    ...
    fn will_provide_all_information_and_respect_export_ignore() -> gix_testtools::Result {
        ...
        let mut stream = gix_archive::Stream::from_read(tee_read);
        ...
        let mut copied_stream = gix_archive::Stream::from_read(std::io::Cursor::new(copy.lock().as_bytes().to_owned()));

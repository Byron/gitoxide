...
// TODO: put somewhere better maybe? Toplevel?
...
pub mod decode_entry {
    ...
    use crate::{
        pack::data::file::{apply_delta, delta_header_size_ofs},
    ...
    impl Outcome {
        ...
        fn from_object_entry(kind: git_object::Kind, entry: &pack::data::Entry, compressed_size: usize) -> Self {
            Self {
                kind,
                num_deltas: 0,
    ...
    impl File {
        ...
        fn resolve_deltas(
            ...
            let object_kind =
                object_kind.expect("a base object as root of any delta chain that we are here to resolve");

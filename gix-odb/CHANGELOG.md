...
* **Uncategorized**
    ...
    - Adapt to changes in `gix-object` (Find::try_header()) ([`336d161`](https://github.com/Byron/gitoxide/commit/336d161a4a291b5cb03c08e637c6f47a05731996))
    ...
    - Adapt to changes in `gix-pack` ([`40e7440`](https://github.com/Byron/gitoxide/commit/40e74404e87e44b0b2a5fe3d294f3ddc5ed2ba88))
    - Remove `Find` trait (as it's now living in `gix-odb`) ([`fad2982`](https://github.com/Byron/gitoxide/commit/fad298228ca91298abe42af41defb8f6c89c3cc9))

...
(enter git-object && indent cargo diet -n --package-size-limit 10KB)
(enter git-odb && indent cargo diet -n --package-size-limit 25KB)
...
(enter gitoxide-core && indent cargo diet -n --package-size-limit 5KB)

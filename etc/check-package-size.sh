...
(enter git-index && indent cargo diet -n --package-size-limit 20KB)
...
(enter git-pack && indent cargo diet -n --package-size-limit 105KB)
(enter git-odb && indent cargo diet -n --package-size-limit 105KB)

...
(enter git-tempfile && indent cargo diet -n --package-size-limit 5KB)
...
(enter git-ref && indent cargo diet -n --package-size-limit 10KB)
...
(enter git-pack && indent cargo diet -n --package-size-limit 60KB)
(enter git-odb && indent cargo diet -n --package-size-limit 100KB)

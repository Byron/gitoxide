...
for crate in git-actor git-tempfile git-lock git-hash git-features git-url git-validate git-object git-ref git-traverse git-diff git-pack git-odb git-packetline git-transport git-protocol git-repository gitoxide-core .; do

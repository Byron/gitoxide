...
for crate in git-features git-url git-hash git-ref git-object git-traverse git-diff git-pack git-odb git-packetline git-transport git-protocol git-repository gitoxide-core .; do

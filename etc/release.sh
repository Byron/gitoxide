...
for crate in git-tempfile git-lock git-features git-url git-validate git-hash git-ref git-object git-traverse git-diff git-pack git-odb git-packetline git-transport git-protocol git-repository gitoxide-core .; do
